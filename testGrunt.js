...
module.exports = function (grunt) {
  ...
  // package snake 项目
  grunt.registerTask('snake', ['clean:snake', 'sass:snake', 'cssmin:snake', 'webpack:lit', 'copy:snake']);

  // lego
  grunt.registerTask('lego', ['clean:lego', 'sass:lego', 'cssmin:lego', 'webpack:lit', 'copy:lego']);
